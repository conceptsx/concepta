...
questions = [
    ...
    ("What does 'AD' stand for?", ["Assistive Device", "American with Disabilities Act", "American Diabetes Association"], "c"),
    ("What does 'ADA' stand for?", ["American with Disabilities Act", "American Dental Association", "American Diabetes Association"], "a"),
    ("What does 'add.' mean?", ["adduction", "addition", "abduction"], "b"),
    ("What does 'ADL' stand for?", ["activities of daily living", "assistive device", "active daily living"], "c"),
    ("What does 'ad lib' mean?", ["at discretion", "as needed", "at liberty"], "b"),
    ("What does 'AE' mean?", ["above elbow", "below elbow", "ankle extension"], "a"),
    ("What does 'AFO' stand for?", ["anterior foot orthoses", "ankle foot orthoses", "anterior cruciate ligament"], "c"),
    ("What does 'AIIS' stand for?", ["anterior inferior iliac spine", "anterior ilium inferior spine", "anterior iliac inferior spine"], "b"),
    ("What does 'A/K' mean?", ["around knee", "above knee", "ankle/knee"], "a"),
    ("What does 'AKA' stand for?", ["above knee amputation", "anterior knee arthroplasty", "ankle knee arthroplasty"], "b"),
    ("What does 'AKS' mean?", ["anterior knee surgery", "arthroscopic knee surgery", "arthroplasty knee surgery"], "c"),
    ...
    ("What does 'amb' mean?", ["ambulation", "ambulance", "ambulation device"], "c"),
    ("What does 'amt' mean?", ["amount", "amputation", "ambulation"], "b"),
    ("What does 'ant' mean?", ["anterolateral", "anterior", "anteroposterior"], "b"),
    ("What does 'ante' mean?", ["before", "after", "around"], "a"),
    ("What does 'AOTA' stand for?", ["American Occupational Therapy Association", "American Osteopathic Therapy Association", "American Orthopedic Therapy Association"], "b"),
    ("What does 'A-P' stand for?", ["anterior-posterior", "anteroposterior", "anterior-proximal"], "a"),
    ("What does 'appt' stand for?", ["appointment", "appropriate", "approximate"], "c"),
    ...
    ("What does 'AROM' stand for?", ["active range of motion", "active range of movement", "assistive range of motion"], "b"),
    ("What does 'ASAP' mean?", ["as soon as possible", "as shortly as possible", "at soon as possible"], "a"),
    ("What does 'ASHA' stand for?", ["American Speech Language Hearing Association", "American Speech and Language Association", "American Speech and Hearing Association"], "c"),
    ("What does 'ASIS' stand for?", ["anterior superior iliac spine", "anterior spine iliac segment", "anterior spine iliac support"], "b"),
    ("What does 'assist.' stand for?", ["assistant", "assistance", "assistantship"], "a"),
    ("What does 'ATNR' stand for?", ["asymmetrical tonic neck reflex", "asymmetrical tonic neural reflex", "asymmetrical tonic neurological response"], "b"),
    ...
    ("What does 'BBFA' stand for?", ["both bone forearm fractures", "bilateral forearm fractures", "bilateral bone forearm fractures"], "c"),
    ...
    ("What does 'bil.' stand for?", ["bilateral limbs", "bilateral", "bilateral arms"], "c"),
    ("What does 'biw' mean?", ["bi-weekly therapy", "bi-weekly", "twice a week"], "b"),
    ("What does 'B/K' mean?", ["below knee joint", "below knee", "below knee amputation"], "a"),
    ("What does 'BKA' stand for?", ["below knee alignment", "below knee amputation", "below knee arthroplasty"], "c"),
    ("What does 'BLE' stand for?", ["both lower extremities", "bilateral lower extremities", "below lower extremities"], "b"),
    ("What does 'BMI' stand for?", ["body muscle index", "body mass index", "body metabolic index"], "a"),
    ("What does 'BOS' stand for?", ["base of support", "base of spine", "basis of support"], "b"),
    ...
    ("What does 'BR' stand for?", ["bedroom rest", "bedroom", "bedrest"], "a"),
    ...
    ("What does 'CARF' stand for?", ["Commission on Rehabilitation Facilities", "Commission on Accreditation of Rehabilitation Facilities", "Commission on Accreditation of Rehab Facilities"], "a"),
    ...
    ("What does 'CCCE' stand for?", ["Coordinator of Clinical Education", "Center Coordinator of Clinical Education", "Center Coordinator for Clinical Education"], "a"),
    ("What does 'C & DB' stand for?", ["cough and deep breaths exercises", "cough and deep breathing", "cough and deep breaths"], "b"),
    ("What does 'CGA' stand for?", ["contact guard assistance", "contact guard assist", "contact guard assistive"], "c"),
    ("What does 'CHD' stand for?", ["congenital heart disease", "congenital heart defect", "congenital heart disorder"], "a"),
    ("What does 'CHI' stand for?", ["closed head injury", "closed head infection", "closed head incident"], "c"),
    ("What does 'CI' stand for?", ["Clinical Instructor Coordinator", "Clinical Instructive", "Clinical Instructor"], "b"),
    ("What does 'CiTx' stand for?", ["cervical intermittent traction", "cervical intensive traction", "cervical intervertebral traction"], "a"),
    ("What does 'cm' mean?", ["centimeters", "centimeter", "cubic meter"], "b"),
    ...
    ("What does 'coord' mean?", ["coordinator", "coordination", "coordination movement"], "c"),
    ("What does 'CP' mean?", ["cranial palsy", "compression pump", "cerebral palsy"], "b"),
    ("What does 'CPM' stand for?", ["controlled passive motion", "continuous passive motion", "continuous positive movement"], "b"),
    ("What does 'CMS' stand for?", ["Centers for Medicaid Services", "Centers for Medicare & Medicaid Services", "Centers for Medicare Services"], "c"),
    ("What does 'CN' mean?", ["cranial nerve", "central nerve", "cervical nerve"], "a"),
    ("What does 'cont' mean?", ["continual", "continued", "continue"], "b"),
    ("What does 'CORF' stand for?", ["Comprehensive Outpatient Rehab Facility", "Comprehensive Outpatient Rehabilitation Facility", "Comprehensive Outpatient Rehabilitation Fund"], "a"),
    ("What does 'COTA' stand for?", ["certified occupational therapist assistant", "certified occupational therapy assistant", "certified occupational therapist aide"], "c"),
    ...
    ("What does 'CRF' stand for?", ["chronic renal failure", "cranial renal failure", "cerebral renal failure"], "b"),
    ("What does 'CSF' stand for?", ["central spinal fluid", "cerebral spinal fluid", "cranial spinal fluid"], "c"),
    ("What does 'CT scan' stand for?", ["computed tomography", "computed axial tomography", "central axial tomography"], "b"),
    ...
    ("What does 'd/c' mean?", ["discontinued", "discharged", "disconnected"], "b"),
    ("What does 'DEP' mean?", ["data, evaluation, progress", "data, evaluation, performance goals", "data, evaluation, procedures"], "c"),
    ("What does 'Dept' stand for?", ["depot", "department", "deposition"], "b"),
    ("What does 'DIP' stand for?", ["distal interphalangeal fracture", "distal interphalangeal joint", "distal interphalangeal"], "c"),
    ...
    ("What does 'DME' stand for?", ["durable medical emergency", "durable medical equipment", "durable medical evaluation"], "a"),
    ...
    ("What does 'DOD' mean?", ["date of discharge", "date of diagnosis", "date of death"], "a"),
    ...
    ("What does 'DRGs' stand for?", ["Diagnosis-Related Grading", "Diagnosis-Related Groups", "Diagnosis-Related Goals"], "a"),
    ("What does 'DTR' stand for?", ["deep tendon reflex", "deep tendon response", "deep tendon reaction"], "b"),
    ("What does 'DSD' mean?", ["dry sterile diagnosis", "dry sterile dressing", "dry sterile drug"], "b"),
    ("What does 'DVT' stand for?", ["deep vein thrombosis", "deep vascular thrombosis", "deep venous thrombosis"], "a"),
    ...
    ("What does 'EMG' stand for?", ["electromyogram", "electromyography", "electromyograph"], "b"),
    ...
    ("What does 'FES' stand for?", ["functional electrical stimulation", "functional electrical study", "functional electrical system"], "c"),
    ...
    ("What does 'Fx' stand for?", ["function", "flex", "fracture"], "c"),
    ...
    ("What does 'GMT' stand for?", ["gross muscle testing", "gross muscle test", "gross muscle test"], "c"),
    ("What does 'gt.' mean?", ["gate", "gait", "gait"], "b"),
    ("What does 'GXT' stand for?", ["graded exercise test", "graded exercise testing", "graded exercise test"], "c"),
    ...
    ("What does 'LOP' stand for?", ["loss of position", "lateral oblique position", "length of procedure"], "b"),
